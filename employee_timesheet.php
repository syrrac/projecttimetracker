...
<body>
<span><a href="logout.php">Sign Out of Your Account</a></span>
<form action= "employee_timesheet.php" method ="post">
  <div class="dropdown">
...
/*      for ($c = 0, $count = count($_POST['Actuals']); $c < $count; $c++){
      ...
      for ($c = $j, $count = count($_POST['Actuals']); $c < $count; $c++){
        ...
        if ($update){
          echo "<meta http-equiv=\"refresh\" content = \"0; URL = employee_timesheet.php\">";
